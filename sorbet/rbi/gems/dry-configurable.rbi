...
class Dry::Configurable::Config
  ...
  def values; end
  include Anonymous_Dry_Core_Equalizer_1
  include Dry::Core::Equalizer::Methods
end
module Anonymous_Dry_Core_Equalizer_1
...
class Dry::Configurable::Setting
  ...
  def writer?(meth); end
  def writer_name; end
  include Anonymous_Dry_Core_Equalizer_2
  include Dry::Core::Equalizer::Methods
end
module Anonymous_Dry_Core_Equalizer_2
  def cmp?(comparator, other); end
  def hash; end
end
...
class Dry::Configurable::Settings
  ...
  def keys; end
  def pristine; end
  include Anonymous_Dry_Core_Equalizer_3
  include Dry::Core::Equalizer::Methods
  include Enumerable
end
module Anonymous_Dry_Core_Equalizer_3
  def cmp?(comparator, other); end
  def hash; end
  def inspect; end
end
